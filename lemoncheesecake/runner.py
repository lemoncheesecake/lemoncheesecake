...
def run_session(suites, fixture_registry, prerun_session_scheduled_fixtures, reporting_backends, report_dir,
                force_disabled=False, stop_on_failure=False, nb_threads=1, save_mode=None):
    ...
    initialize_reporting_backends(
        reporting_backends, report_dir, report, parallel=nb_threads > 1 and nb_tests > 1, save_mode=save_mode
    )
